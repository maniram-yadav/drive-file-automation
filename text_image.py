...
class TextOverlayEngine:
    ...
    def create_overlay(self, image_path, output_name, title="", content="", 
        ...
        with Image.open(image_path) as img:
            ...
            # Initial y-position (Top center start)
            current_y = padding
            
            # Draw Title
            draw.text((img.width/2, current_y), title, font=font_title, 
...
if __name__ == "__main__":
    ...
    engine.create_overlay(
        ...
        title="My Awesome Title, My Awesome Title,  My Awesome Title",
        content="This is the content section. It will wrap automatically if it exceeds the width of the image while maintaining padding.",
        font_path="arial.ttf", # Ensure this font file exists on your system
        title_size=50,
        content_size=40,
        text_color=(0, 0, 0)
    )